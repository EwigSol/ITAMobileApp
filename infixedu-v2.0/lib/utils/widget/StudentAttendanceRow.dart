...
import 'package:italms/utils/custom_widgets/CustomRadioButton/CustomButton/ButtonTextStyle.dart';
import 'package:italms/utils/custom_widgets/CustomRadioButton/custom_radio_button.dart';
import 'package:italms/utils/model/Attendance.dart';
import 'package:italms/utils/model/GlobalClass.dart';
...
class _StudentAttendanceRowState extends State<StudentAttendanceRow> {
  ...
  void setAttendance() async {
    print(
        'ATTEN: ${InfixApi.attendanceDataSend('${attendanceStudents.sId}', atten, date, mClass, mSection)}');
    final response = await http.get(
        Uri.parse(InfixApi.attendanceDataSend(
