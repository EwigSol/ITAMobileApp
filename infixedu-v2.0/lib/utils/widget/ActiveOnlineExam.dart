...
// Project imports:
import 'package:italms/utils/model/ActiveOnlineExam.dart';
...
class ActiveOnlineExamRow extends StatelessWidget {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        getStatus(context, exam.status, exam.isRunning,
                            exam.isClosed),
                      ],
                    ),
                  ),
  ...
  Widget getStatus(BuildContext context, dynamic status, dynamic isRunning,
      dynamic isClosed) {
    if (status == 1) {
      return Container(
